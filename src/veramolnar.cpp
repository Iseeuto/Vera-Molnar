...
int main(){
    ...
    svg_to_html("tab3.html", canvas_to_svg_veramolnar(C3, LTC3));
    ...
    svg_to_html("tab4.html", canvas_to_svg_veramolnar(C4, LTC4));
    ...
    svg_to_html("tab5.html", canvas_to_svg_veramolnar(C5, LTC5));
